...
public class SemesterTest {
  ...
  public void givenSameSemester_whenComparingSemester_shouldBeEqual() {
    Semester A_SEMESTER = new Semester(Season.A, 2020);
    Semester SAME_SEMESTER = new Semester(Season.A, 2020);
  ...
  public void givenDifferentSemester_whenComparingSemester_shouldNotBeEqual() {
    final Semester A_SEMESTER = new Semester(Season.A, 2020);
    final Semester OTHER_SEMESTER = new Semester(Season.H, 2020);
  ...
  public void givenAutumnSemester_whenAdding1Semester_ShouldBeWinterOfNextYear() {
    final Semester AUTUMN_SEMESTER = new Semester(Season.A, 2020);

    Semester nextSemester = AUTUMN_SEMESTER.addSemester(1);

    assertThat(nextSemester).isEqualTo(new Semester(Season.H, 2021));
  }

  @Test
  public void givenSummerSemester_whenAdding1Semester_ShouldBeAutumnOfSameYear() {
    final Semester WINTER_SEMESTER = new Semester(Season.E, 2020);

    Semester nextSemester = WINTER_SEMESTER.addSemester(1);

    assertThat(nextSemester).isEqualTo(new Semester(Season.A, 2020));
  }
  ...
  public void givenWinterSemester_whenAdding3Semester_ShouldBeWinterOfNextYear() {
    final Semester WINTER_SEMESTER = new Semester(Season.H, 2020);
