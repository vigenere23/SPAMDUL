...
public class ParkingAccessLogFilterTest {
  ...
  private final ParkingAccessLog TODAY_ACCESS_LOG = new ParkingAccessLog(new ParkingAccessLogId(),
                                                                         ParkingZone.ZONE_1,
                                                                         LocalDate.now());
  private final ParkingAccessLog TODAY_ACCESS_LOG_COPY = new ParkingAccessLog(new ParkingAccessLogId(),
                                                                              ParkingZone.ZONE_1,
                                                                              LocalDate.now());
  private final ParkingAccessLog FUTURE_ACCESS_LOG = new ParkingAccessLog(new ParkingAccessLogId(),
                                                                          ParkingZone.ZONE_1,
                                                                          LocalDate.now().plusDays(1));
  private final ParkingAccessLog PREVIOUS_MONTH_ACCESS_LOG = new ParkingAccessLog(new ParkingAccessLogId(),
                                                                                  ParkingZone.ZONE_1,
