...
public class CarServiceTest {
  ...
  public void setUp() throws Exception {
    ...
    carService = new CarService(carFactory, carRepository, userRepository);
  }
  ...
  public void whenCreatingCar_shouldSaveCarInRepo() {
    given(carFactory.create(carDto.brand, carDto.model, carDto.year, carDto.licensePlate, carDto.userId)).willReturn(car);
