...
public class RevenueResourceTest {
  ...
  public void setUp() throws Exception {
    ...
    resource = new RevenueResource(revenueUseCase,
                                   transactionQueryAssembler,
                                   revenueAssembler,
                                   cookieAssembler);
    carTypeRevenues = generateCarTypesRevenues();
    BDDMockito.given(transactionQueryAssembler.fromValues(Matchers.any(), Matchers.any()))
              .willReturn(A_TRANSACTION_QUERY_DTO);
  }

  @Test
  public void whenGettingCarTypeTotalRevenue_shouldReturnResponseWithCorrectInfos() {
    BDDMockito.given(revenueUseCase.getCampusAccessTotalRevenueByCarType(A_TRANSACTION_QUERY_DTO,
  ...
  public void whenGettingTotalInfractionsRevenue_shouldReturnResponseWithCorrectInfos() {
    BDDMockito.given(revenueUseCase.getInfractionsTotalRevenue(A_TRANSACTION_QUERY_DTO, A_TEMPORARY_TOKEN))
              .willReturn(AMOUNT_1);
  ...
  public void whenGettingTotalPassRevenue_shouldReturnResponseWithCorrectInfos() {
    BDDMockito.given(revenueUseCase.getPassTotalRevenue(A_TRANSACTION_QUERY_DTO, A_TEMPORARY_TOKEN)).willReturn(
        AMOUNT_1);
  ...
  public void whenGettingTotalCarbonCreditsBought_shouldReturnResponseWithCorrectInfo() {
    BDDMockito.given(revenueUseCase.getAllBoughtCarbonCredit(A_TEMPORARY_TOKEN)).willReturn(SOME_CREDITS);
