...
public class DevInitiativesContextTest {

  private DevInitiativesContext context;
  ...
  public void setUp() {
    ...
    context = new DevInitiativesContext(initiativeTransactionService, authenticationRepository, cookieAssembler);
  }
