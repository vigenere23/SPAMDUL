...
public class UserFactory {
  ...
  public User create(String name, Gender gender, LocalDate birthdayDate, DayOfWeek dayToAccessCampus) {
    ...
    return new User(name, gender, birthdayDate, dayToAccessCampus);
  }
}
